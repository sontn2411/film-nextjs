...
'use client'
import { useGetDataFilmList, useGetDataFilter } from '@/axios/query'
...
const ContentTypeList = ({ type_list, page }: ContentTypeListProps) => {
      ...
      <div className='pt-10 flex flex-col justify-center '>
        {data && (
          <>
            ...
            <PaginationFilm totalItems={data.params.pagination.totalPages} />
          </>
        )}
      </div>
    </div>
